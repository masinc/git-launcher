...
function App() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 p-6 bg-white min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">🚀 GitHub Launcher Settings</h1>
        <p className="text-gray-600">Configure tools and options for the GitHub Launcher extension.</p>
      </div>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-3">
          {settings.tools.map(tool => (
            <div key={tool.id} className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <input
                type="checkbox"
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-500 mt-1">{tool.urlTemplate}</div>
              </div>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4 text-gray-800">Add Custom Tool</h2>
        <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-sm text-gray-500 mb-2">
            Example: <code className="bg-gray-200 px-1 rounded">https://example.com/repo/{'{owner}'}/{'{repo}'}</code>
          </div>
          <button
      ...
      <section>
        ...
        <label className="flex items-center cursor-pointer p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
          ...
          />
          <div>
            <div className="font-medium text-gray-900">Show in context menu</div>
            <div className="text-sm text-gray-500">Enable right-click menu on GitHub pages</div>
          </div>
        </label>
      </section>
    </div>
